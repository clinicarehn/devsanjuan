    ...
    if(!$sock = @fsockopen('www.google.com', 80)){ 
       ...
       while($registro2 = $result_agenda_cosnsulta->fetch_assoc()){ 
	    ...
	    if($valor == 9 || $valor == 8 || $valor == 7 || $valor == 3){//VERIFICAMOS QUE LOS NUMEROS SEAN CELULARES
	        ...
	        $to = $area."".$telefono;  
			$mensaje = "Estimado(a) $nombre_usuario $nombre_apellido, le recordamos, su cita es el $dia_nombre $dia de $mes. Favor estar 15 minutos antes. Su cita es presencial";				
