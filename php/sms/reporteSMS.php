...
if($servicio != "" && $unidad == "" && $profesional == "" && $usuario == "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
}else if($servicio != "" && $unidad != "" && $profesional == "" && $usuario == "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
}else if($servicio != "" && $unidad != "" && $profesional != "" && $usuario == "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND c.puesto_id = '$unidad' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
}else if($servicio != "" && $unidad != "" && $profesional != "" && $usuario != "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
    ...
    if($dias == 1){
		$dias_reporte  = "Reporte de ".$dias." día";
	}else{
		$dias_reporte  = "Reporte de ".$dias." días";
	}		
}else if($servicio != "" && $unidad == "" && $profesional == "" && $usuario == "" && $dias != ""){
	$where = "WHERE s.servicio_id = '$servicio' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf' AND (p.expediente LIKE '%$dato%' OR CONCAT(p.nombre,' ',p.apellido) LIKE '%$dato%' OR p.apellido LIKE '$dato%' OR p.identidad LIKE '$dato%' OR p.telefono LIKE '$dato%' OR p.telefono1 LIKE '$dato%')";
...
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Registro de SMS Enviados en $servicio_name");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:R$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:R$fila");
...
$fila=4;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", $usuario_nombre." ".$dias_reporte);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:R$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:R$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="Reporte SMS enviados '.$servicio_name.' '.$mes.'_'.$año.'.xls"');
