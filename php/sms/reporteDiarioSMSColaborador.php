...
$usuario_ = $_SESSION['colaborador_id'];	

$query_empresa = "SELECT e.nombre AS 'empresa'
FROM users AS u
INNER JOIN empresa AS e
ON u.empresa_id = e.empresa_id
WHERE u.colaborador_id = '$usuario_'";
...
if($servicio != "" && $unidad == "" && $profesional == "" && $usuario == "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
}else if($servicio != "" && $unidad != "" && $profesional == "" && $usuario == "" && $dias == ""){
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND CAST(s.fecha_registro AS DATE BETWEEN '$fechai ' AND '$fechaf";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND c.puesto_id = '$unidad'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.user = '$usuario' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
	...
	$where = "WHERE s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND s.user = '$usuario' AND s.dias = '$dias' AND CAST(s.fecha_registro AS DATE) BETWEEN '$fechai ' AND '$fechaf'";
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte Diario SMS. ".$servicio_name.' '.$unidad_name);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE DIARIO SMS'.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.strtoupper($mes).'_'.$año.'.xls"');
