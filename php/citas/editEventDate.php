...
if($result->num_rows>0){	
	...
	$valores_array = getAgendatime($consultarJornadaJornada_id, $servicio_id, $consultarJornadaServicio_id, $puesto_colaborador, $consulta_agenda_id, $hora_h, $consulta_nuevos_devuelto, $consultarJornadaNuevos, $consultaJornadaTotal, $consulta_subsiguientes_devuelto);
...
if($hora=="Nula" || $hora=="Vacio" || $hora=="NuevosExcede" || $hora=="NulaSError" || $hora=="NulaN" || $hora=="NulaS" || $hora=="SubsiguienteExcede"){
	echo 5;
}else{
      ...
      if ( $consultar_medico1['agenda_id'] == ""){
	     if ( $consultar_usuario1['agenda_id'] == ""){
		    ...
		    if($status_anterior == 0){			
			   ...
			   $historial_numero = historial();
			   $estado = "Eliminar";
			   $observacion = "Se elimina la cita para este registro";
			   $modulo = "Citas";
			   $insert = "INSERT INTO historial 
			          VALUES('$historial_numero','$pacientes_id','$expediente','$modulo','$agenda_id','$colaborador_id','$servicio_id','$start','$estado','$observacion','$usuario','$fecha_registro')";
			   $mysqli->query($insert);
		    ...
		    $insert = "INSERT INTO agenda 
			    VALUES('$numero_agenda', '$pacientes_id', '$expediente', '$colaborador_id', '$hora' ,'$start', '$end', '$fecha_registro', '0', '$color_repro', '$observacion1' , '$usuario', '$servicio_id', '','0','0','1','$paciente','0')";
