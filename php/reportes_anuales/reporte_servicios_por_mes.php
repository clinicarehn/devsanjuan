...
if($result->num_rows>0){
	while($registro2 = $result->fetch_assoc()){
       ...
       $objPHPExcel->getActiveSheet()->SetCellValue("D$fila", $registro2['nuevo']);
       $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $registro2['sub']);	
