...
if($unidad == "" && $colaborador_usuario == ""){
	...
	$where = "WHERE CAST(a.fecha_registro AS DATE) BETWEEN '$desde' AND '$hasta' AND a.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.reprogramo = 1";
}else{
    //OBTENER NOMBRE UNIDAD
    $consulta_unidad = "SELECT nombre 
	    FROM puesto_colaboradores 
...
COUNT(CASE WHEN DAY(a.fecha_registro) = 1 THEN a.agenda_id END) AS '1',  
COUNT(CASE WHEN DAY(a.fecha_registro) = 2 THEN a.agenda_id END) AS '2',
COUNT(CASE WHEN DAY(a.fecha_registro) = 3 THEN a.agenda_id END) AS '3',
COUNT(CASE WHEN DAY(a.fecha_registro) = 4 THEN a.agenda_id END) AS '4',
COUNT(CASE WHEN DAY(a.fecha_registro) = 5 THEN a.agenda_id END) AS '5',
COUNT(CASE WHEN DAY(a.fecha_registro) = 6 THEN a.agenda_id END) AS '6',
COUNT(CASE WHEN DAY(a.fecha_registro) = 7 THEN a.agenda_id END) AS '7',
COUNT(CASE WHEN DAY(a.fecha_registro) = 8 THEN a.agenda_id END) AS '8',
COUNT(CASE WHEN DAY(a.fecha_registro) = 9 THEN a.agenda_id END) AS '9',
COUNT(CASE WHEN DAY(a.fecha_registro) = 10 THEN a.agenda_id END) AS '10',
COUNT(CASE WHEN DAY(a.fecha_registro) = 11 THEN a.agenda_id END) AS '11',  
COUNT(CASE WHEN DAY(a.fecha_registro) = 12 THEN a.agenda_id END) AS '12',
COUNT(CASE WHEN DAY(a.fecha_registro) = 13 THEN a.agenda_id END) AS '13',
COUNT(CASE WHEN DAY(a.fecha_registro) = 14 THEN a.agenda_id END) AS '14',
COUNT(CASE WHEN DAY(a.fecha_registro) = 15 THEN a.agenda_id END) AS '15',
COUNT(CASE WHEN DAY(a.fecha_registro) = 16 THEN a.agenda_id END) AS '16',
COUNT(CASE WHEN DAY(a.fecha_registro) = 17 THEN a.agenda_id END) AS '17',
COUNT(CASE WHEN DAY(a.fecha_registro) = 18 THEN a.agenda_id END) AS '18',
COUNT(CASE WHEN DAY(a.fecha_registro) = 19 THEN a.agenda_id END) AS '19',
COUNT(CASE WHEN DAY(a.fecha_registro) = 20 THEN a.agenda_id END) AS '20',
COUNT(CASE WHEN DAY(a.fecha_registro) = 21 THEN a.agenda_id END) AS '21',  
COUNT(CASE WHEN DAY(a.fecha_registro) = 22 THEN a.agenda_id END) AS '22',
COUNT(CASE WHEN DAY(a.fecha_registro) = 23 THEN a.agenda_id END) AS '23',
COUNT(CASE WHEN DAY(a.fecha_registro) = 24 THEN a.agenda_id END) AS '24',
COUNT(CASE WHEN DAY(a.fecha_registro) = 25 THEN a.agenda_id END) AS '25',
COUNT(CASE WHEN DAY(a.fecha_registro) = 26 THEN a.agenda_id END) AS '26',
COUNT(CASE WHEN DAY(a.fecha_registro) = 27 THEN a.agenda_id END) AS '27',
COUNT(CASE WHEN DAY(a.fecha_registro) = 28 THEN a.agenda_id END) AS '28',
COUNT(CASE WHEN DAY(a.fecha_registro) = 29 THEN a.agenda_id END) AS '29',
COUNT(CASE WHEN DAY(a.fecha_registro) = 30 THEN a.agenda_id END) AS '30',
COUNT(CASE WHEN DAY(a.fecha_registro) = 31 THEN a.agenda_id END) AS '31',
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Diario de Reprogramaciones. ".$servicio_name.' '.$unidad_name);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE DIARIO DE REPROGRAMACIONES'.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.strtoupper($mes).'_'.$año.'.xls"');
