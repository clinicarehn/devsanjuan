...
$where = "WHERE CAST(a.fecha_cita AS DATE) BETWEEN '$desde' AND '$hasta' AND a.servicio_id = '$servicio' AND a.preclinica = '0' AND c.puesto_id = '2'";
...
COUNT(CASE WHEN DAY(a.fecha_cita) = 1 THEN a.paciente END) AS '1',  
COUNT(CASE WHEN DAY(a.fecha_cita) = 2 THEN a.paciente END) AS '2',
COUNT(CASE WHEN DAY(a.fecha_cita) = 3 THEN a.paciente END) AS '3',
COUNT(CASE WHEN DAY(a.fecha_cita) = 4 THEN a.paciente END) AS '4',
COUNT(CASE WHEN DAY(a.fecha_cita) = 5 THEN a.paciente END) AS '5',
COUNT(CASE WHEN DAY(a.fecha_cita) = 6 THEN a.paciente END) AS '6',
COUNT(CASE WHEN DAY(a.fecha_cita) = 7 THEN a.paciente END) AS '7',
COUNT(CASE WHEN DAY(a.fecha_cita) = 8 THEN a.paciente END) AS '8',
COUNT(CASE WHEN DAY(a.fecha_cita) = 9 THEN a.paciente END) AS '9',
COUNT(CASE WHEN DAY(a.fecha_cita) = 10 THEN a.paciente END) AS '10',
COUNT(CASE WHEN DAY(a.fecha_cita) = 11 THEN a.paciente END) AS '11',  
COUNT(CASE WHEN DAY(a.fecha_cita) = 12 THEN a.paciente END) AS '12',
COUNT(CASE WHEN DAY(a.fecha_cita) = 13 THEN a.paciente END) AS '13',
COUNT(CASE WHEN DAY(a.fecha_cita) = 14 THEN a.paciente END) AS '14',
COUNT(CASE WHEN DAY(a.fecha_cita) = 15 THEN a.paciente END) AS '15',
COUNT(CASE WHEN DAY(a.fecha_cita) = 16 THEN a.paciente END) AS '16',
COUNT(CASE WHEN DAY(a.fecha_cita) = 17 THEN a.paciente END) AS '17',
COUNT(CASE WHEN DAY(a.fecha_cita) = 18 THEN a.paciente END) AS '18',
COUNT(CASE WHEN DAY(a.fecha_cita) = 19 THEN a.paciente END) AS '19',
COUNT(CASE WHEN DAY(a.fecha_cita) = 20 THEN a.paciente END) AS '20',
COUNT(CASE WHEN DAY(a.fecha_cita) = 21 THEN a.paciente END) AS '21',  
COUNT(CASE WHEN DAY(a.fecha_cita) = 22 THEN a.paciente END) AS '22',
COUNT(CASE WHEN DAY(a.fecha_cita) = 23 THEN a.paciente END) AS '23',
COUNT(CASE WHEN DAY(a.fecha_cita) = 24 THEN a.paciente END) AS '24',
COUNT(CASE WHEN DAY(a.fecha_cita) = 25 THEN a.paciente END) AS '25',
COUNT(CASE WHEN DAY(a.fecha_cita) = 26 THEN a.paciente END) AS '26',
COUNT(CASE WHEN DAY(a.fecha_cita) = 27 THEN a.paciente END) AS '27',
COUNT(CASE WHEN DAY(a.fecha_cita) = 28 THEN a.paciente END) AS '28',
COUNT(CASE WHEN DAY(a.fecha_cita) = 29 THEN a.paciente END) AS '29',
COUNT(CASE WHEN DAY(a.fecha_cita) = 30 THEN a.paciente END) AS '30',
COUNT(CASE WHEN DAY(a.fecha_cita) = 31 THEN a.paciente END) AS '31',
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Usuarios Pendientes en Preclínica. ".$servicio_name.' '.$unidad_name);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AH$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AH$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE DIARIO DE ATENCIONES PRECLINICA'.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.strtoupper($mes).'_'.$año.'.xls"');
