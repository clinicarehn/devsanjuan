...
if($servicio != "" && $unidad == "" && $profesional == "" && $reporte != ""){
  $where = "WHERE CAST(a.fecha_cita AS DATE) BETWEEN '$desde' AND '$hasta' AND a.servicio_id = '$servicio' AND a.status = '$reporte'";		
}else if ($servicio != "" && $unidad != "" && $profesional == "" && $reporte != ""){
  $where = "WHERE CAST(a.fecha_cita AS DATE) BETWEEN '$desde' AND '$hasta' AND a.servicio_id = '$servicio' AND a.status = '$reporte' AND c.puesto_id = '$unidad'";				
}else{
  $where = "WHERE CAST(a.fecha_cita AS DATE) BETWEEN '$desde' AND '$hasta' AND a.servicio_id = '$servicio' AND a.status = '$reporte' AND c.puesto_id = '$unidad' AND c.colaborador_id = '$profesional'";
}
