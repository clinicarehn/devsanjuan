...
COUNT(CASE WHEN DAY(so.fecha) = 1 THEN a.paciente END) AS '1',  
COUNT(CASE WHEN DAY(so.fecha) = 2 THEN a.paciente END) AS '2',
COUNT(CASE WHEN DAY(so.fecha) = 3 THEN a.paciente END) AS '3',
COUNT(CASE WHEN DAY(so.fecha) = 4 THEN a.paciente END) AS '4',
COUNT(CASE WHEN DAY(so.fecha) = 5 THEN a.paciente END) AS '5',
COUNT(CASE WHEN DAY(so.fecha) = 6 THEN a.paciente END) AS '6',
COUNT(CASE WHEN DAY(so.fecha) = 7 THEN a.paciente END) AS '7',
COUNT(CASE WHEN DAY(so.fecha) = 8 THEN a.paciente END) AS '8',
COUNT(CASE WHEN DAY(so.fecha) = 9 THEN a.paciente END) AS '9',
COUNT(CASE WHEN DAY(so.fecha) = 10 THEN a.paciente END) AS '10',
COUNT(CASE WHEN DAY(so.fecha) = 11 THEN a.paciente END) AS '11',  
COUNT(CASE WHEN DAY(so.fecha) = 12 THEN a.paciente END) AS '12',
COUNT(CASE WHEN DAY(so.fecha) = 13 THEN a.paciente END) AS '13',
COUNT(CASE WHEN DAY(so.fecha) = 14 THEN a.paciente END) AS '14',
COUNT(CASE WHEN DAY(so.fecha) = 15 THEN a.paciente END) AS '15',
COUNT(CASE WHEN DAY(so.fecha) = 16 THEN a.paciente END) AS '16',
COUNT(CASE WHEN DAY(so.fecha) = 17 THEN a.paciente END) AS '17',
COUNT(CASE WHEN DAY(so.fecha) = 18 THEN a.paciente END) AS '18',
COUNT(CASE WHEN DAY(so.fecha) = 19 THEN a.paciente END) AS '19',
COUNT(CASE WHEN DAY(so.fecha) = 20 THEN a.paciente END) AS '20',
COUNT(CASE WHEN DAY(so.fecha) = 21 THEN a.paciente END) AS '21',  
COUNT(CASE WHEN DAY(so.fecha) = 22 THEN a.paciente END) AS '22',
COUNT(CASE WHEN DAY(so.fecha) = 23 THEN a.paciente END) AS '23',
COUNT(CASE WHEN DAY(so.fecha) = 24 THEN a.paciente END) AS '24',
COUNT(CASE WHEN DAY(so.fecha) = 25 THEN a.paciente END) AS '25',
COUNT(CASE WHEN DAY(so.fecha) = 26 THEN a.paciente END) AS '26',
COUNT(CASE WHEN DAY(so.fecha) = 27 THEN a.paciente END) AS '27',
COUNT(CASE WHEN DAY(so.fecha) = 28 THEN a.paciente END) AS '28',
COUNT(CASE WHEN DAY(so.fecha) = 29 THEN a.paciente END) AS '29',
COUNT(CASE WHEN DAY(so.fecha) = 30 THEN a.paciente END) AS '30',
COUNT(CASE WHEN DAY(so.fecha) = 31 THEN a.paciente END) AS '31',
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Asegurados. ".$servicio_name.' '.$unidad_name);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AH$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AH$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE DIARIO DE ATENCIONES ASEGURADOS'.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.strtoupper($mes).'_'.$año.'.xls"');
