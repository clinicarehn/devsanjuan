...
if ($servicio_id != 0 && $expediente != 0 && $colaborador != 0 && $usuario != 0 && $status != 0){
  if($fecha_cita_ != "" || $fecha_cita_ == "0000-00-00"){
	  ...
	  $update = "UPDATE depurados SET diagnostico = '$diagnostico', fecha_ultima = '$fecha_cita', colaborador_id = '$colaborador',	colaborador_id1 = '$colaborador1', servicio_id = '$servicio_id', comentario = '$comentario'
