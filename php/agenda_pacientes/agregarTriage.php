...
$insert = "INSERT INTO triage VALUES('$numero','$pacientes_id','$expediente','$colaborador_id','$servicio_id','$fecha','$tipoUsuario','$atencion_triage','$respuesta_triage','$observacion_triage','$informacion_triage','$tipo_triage', '$asistira_triage', '$comentario','$usuario','$fecha_registro')";
...
if($sql){
	...
	$estado = "Actualizar";
	$observacion_historial = "Se ha agregado Triage para este registro";
	$modulo = "Agenda";
