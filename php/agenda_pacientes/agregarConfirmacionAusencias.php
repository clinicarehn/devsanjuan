...
//OBTENER CORRELATIVO
$correlativo= "SELECT MAX(confirmar_ausencias_repro_id) AS max, COUNT(confirmar_ausencias_repro_id) AS count 
   FROM confirmar_ausencias_repro";
...
if($consulta_existencia_cofirmacion == ""){
	  ...
	  if($agenda_id != 0 && $servicio_id != 0 && $pacientes_id != 0 && $colaborador_id != 0 && $usuario != 0){				
		  $insert = "INSERT INTO confirmar_ausencias_repro 
            ...
            $query = $mysqli->query($insert) or die($mysqli->error);
		      ...
		      $estado = "Agregar";
		      $observacion_historial = "Se agrego una nueva confirmación de ausencias para la reprogramación de la agenda para este registro";
		      $modulo = "Agenda";
