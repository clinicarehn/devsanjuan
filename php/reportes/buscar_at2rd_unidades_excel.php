...
$objPHPExcel->getActiveSheet()->SetCellValue("C$fila", "Establecimiento ".$empresa_nombre);
...
// nombre del archivo
header('Content-Disposition: attachment; filename="AT2R DIARIO '.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.$colaborador_name.' '.strtoupper($mes).'_'.$año.'.xls"');
