...
$objPHPExcel->getProperties()->setTitle("AT2R"); //titulo
...
$objPHPExcel->getActiveSheet()->setTitle("AT2R DIARIO"); //establecer titulo de hoja
...
$objPHPExcel->getActiveSheet()->SetCellValue("C$fila", $servicio_name);
$objPHPExcel->getActiveSheet()->mergeCells("C$fila:N$fila"); //unir celdas
...
// nombre del archivo
header('Content-Disposition: attachment; filename="AT2R DIARIO '.strtoupper($servicio_name).' '.strtoupper($mes).'_'.$año.'.xls"');
