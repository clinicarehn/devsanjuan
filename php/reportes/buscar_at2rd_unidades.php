...
if ($servicio != "" && $unidad !="" && $colaborador == ""){
	...
	$where1 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 1 AND 4";
	$where2 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 5 AND 9";
	$where3 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 10 AND 14";
	$where4 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 15 AND 19";
	$where5 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 20 AND 49";
	$where6 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años BETWEEN 50 AND 59";
	$where7 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad' AND a.años >= 60";
	$where8 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.puesto_id = '$unidad'"; //SEXO
}else if ($servicio != "" && $unidad !="" && $colaborador !=""){
	$where = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador'";
	$where1 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 1 AND 4";
	$where2 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 5 AND 9";
	$where3 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 10 AND 14";
	$where4 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 15 AND 19";
	$where5 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 20 AND 49";
	$where6 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años BETWEEN 50 AND 59";
	$where7 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador' AND a.años >= 60";
	$where8 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND c.colaborador_id = '$colaborador'"; //SEXO
}else{
	$where = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio'";
	$where1 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 1 AND 4";
	$where2 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 5 AND 9";
	$where3 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 10 AND 14";
	$where4 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 15 AND 19";
	$where5 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 20 AND 49";
	$where6 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años BETWEEN 50 AND 59";
	$where7 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND s.servicio_id = '$servicio' AND a.años >= 60";
