...
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:Q$fila"); //unir celda
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:Q$fila");
...
header('Content-Disposition: attachment; filename="LISTA DE ESPERA '.strtoupper($servicio_name).' '.strtoupper($unidad_name).' '.$colaborador_name.' '.strtoupper($mes).'_'.$año.'.xls"');
