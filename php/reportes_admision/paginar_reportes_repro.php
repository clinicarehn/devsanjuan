...
//CREAMOS NUESTRA VISTA Y LA DEVOLVEMOS AL AJAX
  	$tabla = $tabla.'<table class="table table-striped table-condensed table-hover">
			<tr>
			    <th width="8.14%">Fecha Solicitud</th>
                <th width="22.14%">Usuario</th>
