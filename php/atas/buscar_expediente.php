...
$valores = "SELECT CONCAT(apellido,' ',nombre) AS 'nombre', departamento_id, municipio_id, localidad
     FROM pacientes
...
if($result->num_rows>0){
	if($expediente != 0){
	    $datos = array(
		        0 => 'Bien',
				1 => $valores2['nombre'],  	
                2 => $valores2['departamento_id'],					
                3 => $valores2['municipio_id'],	
				4 => $valores2['localidad'],	
	   );		
	}else{
	   $datos = array(
				0 => 'Error_Temporal',
