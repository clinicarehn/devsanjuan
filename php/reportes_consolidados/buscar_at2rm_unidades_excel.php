...
if ($servicio != "" && $unidad == ""){
	$where = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años >= 1";
	$where1 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 1 AND 4";
	$where2 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 5 AND 9";
	$where3 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 10 AND 14";
	$where4 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 15 AND 19";
	$where5 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 20 AND 49";
	$where6 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años BETWEEN 50 AND 59";
	$where7 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND a.años>=60";
	$where8 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND p.sexo IN('H','M')";
}else{	
	$where = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años >= 1";
	$where1 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 1 AND 4";
	$where2 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 5 AND 9";
	$where3 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 10 AND 14";
	$where4 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 15 AND 19";
	$where5 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 20 AND 49";
	$where6 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años BETWEEN 50 AND 59";
	$where7 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND a.años>=60";	
	$where8 = "WHERE a.fecha BETWEEN '$desde' AND '$hasta' AND a.servicio_id IN(".$servicio.") AND c.puesto_id = '$unidad' AND p.sexo IN('H','M')";
...
$objPHPExcel->getProperties()->setTitle("AT2R MENSUAL"); //titulo
...
$objPHPExcel->getActiveSheet()->setTitle("AT2R MENSUAL"); //establecer titulo de hoja
...
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", "Establecimiento: Hospital San Juan de Dios.");
...
if($result->num_rows>0){
	if($result1_4->num_rows>0){
		while($registro1_4_1 = $result1_4->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro1_4_1['Especialista']);	
...
if($result5_9->num_rows>0){
		while($registro5_9_1 = $result5_9->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro5_9_1['Especialista']);	
   ...
   if($result10_14->num_rows>0){
		while($registro10_14_1 = $result10_14->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro10_14_1['Especialista']);	
...
if($result15_19->num_rows>0){
		while($registro15_19_1 = $result15_19->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro15_19_1['Especialista']);	
   ...
   if($result20_49->num_rows>0){
		while($registro20_49_1 = $result20_49->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro20_49_1['Especialista']);	
...
if($result50_59->num_rows>0){
		while($registro50_59_1 = $result50_59->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro50_59_1['Especialista']);	
   ...
   if($result60->num_rows>0){
		while($registro60_1 = $result60->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalgeneral_medico);
           $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $registro60_1['Especialista']);	
...
$objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $totalg);
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $totale);
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", $total);
...
$valor++;
  ...
  if($resultSexo->num_rows>0){
		while($sexo_1 = $resultSexo->fetch_assoc()){
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", $sexo_1['General']);
...
// nombre del archivo
header('Content-Disposition: attachment; filename="AT2R MENSUAL '.strtoupper($servicio_name).' '.strtoupper($mes).'_'.$año.'.xls"');
