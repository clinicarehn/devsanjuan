...
$consulta = "SELECT CONCAT(p.nombre,' ',p.apellido) AS 'paciente', p.expediente AS 'expediente', p.identidad AS 'identidad', d.nombre AS 'departamento', m.nombre AS 'municipio', p.sexo AS 'sexo', at.años, re.clinico AS 'clinico', pa1.patologia_id AS 'patologia_id1', pa2.patologia_id AS 'patologia_id2', pa3.patologia_id AS 'patologia_id3'
...
if($result->num_rows>0){
  ...
  $clinico = $consulta1['clinico'];
  
  if($consulta1['patologia_id2']==""){
	$patologia = $consulta1['patologia_id1'];
  }else if($consulta1['patologia_id2']!="" && $consulta1['patologia_id3']==""){
    $patologia = $consulta1['patologia_id1'].'/'.$consulta1['patologia_id2'];		   
  }else{
     $patologia = $consulta1['patologia_id1'].'/'.$consulta1['patologia_id2'].'/'.$consulta1['patologia_id3'];
  }
