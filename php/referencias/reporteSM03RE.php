...
if($servicio != 0){
	$where = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 > 0";
	$where1 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio'";
	$where2 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 1 AND 43";
	$where3 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 44 AND 123";
	$where4 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 124 AND 154";
	$where5 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 155 AND 160";
	$where6 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 161 AND 171";
	$where7 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 172 AND 196";
	$where8 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 197 AND 245";
	$where9 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 246 AND 282";
	$where10 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 283 AND 335";
	$where11 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 336 AND 341";
	$where12 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 342 AND 368";
	$where13 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 369 AND 413";
	$where14 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 414 AND 414";
	$where15 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 BETWEEN 415 AND 415";
	$where16 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 416";
	$where17 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 417";
	$where18 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 418";
	$where19 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 419";
	$where20 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 420";
	$where21 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 421";
	$where22 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 422";
	$where23 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 423";
	$where24 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 424";
	$where25 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 425";
	$where26 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 426";
	$where27 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 427";
	$where28 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 428";
	$where29 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 429";
	$where30 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 430";
	$where31 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 431";
	$where32 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 432";
	$where33 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 433";
	$where34 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 434";
	$where35 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 436";
	$where36 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 437";
	$where37 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 438";
	$where38 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 439";
	$where39 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 440";
	$where40 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 441";
	$where41 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 442";
	$where42 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.servicio_id = '$servicio' AND re.patologia1 = 435";	
	...
	$where = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 > 0";
	$where1 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta'";
	$where2 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 1 AND 43";
	$where3 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 44 AND 123";
	$where4 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 124 AND 154";
	$where5 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 155 AND 160";
	$where6 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 161 AND 171";
	$where7 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 172 AND 196";
	$where8 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 197 AND 245";
	$where9 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 246 AND 282";
	$where10 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 283 AND 335";
	$where11 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 336 AND 341";
	$where12 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 342 AND 368";
	$where13 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 369 AND 413";
	$where14 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 414 AND 414";
	$where15 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 BETWEEN 415 AND 415";
	$where16 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 416";
	$where17 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 417";
	$where18 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 418";
	$where19 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 419";
	$where20 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 420";
	$where21 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 421";
	$where22 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 422";
	$where23 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 423";
	$where24 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 424";
	$where25 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 425";
	$where26 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 426";
	$where27 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 427";
	$where28 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 428";
	$where29 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 429";
	$where30 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 430";
	$where31 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 431";
	$where32 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 432";
	$where33 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 433";
	$where34 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 434";
	$where35 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 436";
	$where36 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 437";
	$where37 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 438";
	$where38 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 439";
	$where39 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 440";
	$where40 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 441";
	$where41 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 442";
	$where42 = "WHERE re.fecha BETWEEN '$desde' AND '$hasta' AND re.patologia1 = 435";
    $servicio_name = "";
}
...
$registro = "SELECT DISTINCT 
   ...
   COUNT(CASE WHEN (a.paciente = 'N' AND p.sexo = 'H') THEN re.patologia1 END) AS 'NUEVO_H',
   COUNT(CASE WHEN (a.paciente = 'N' AND p.sexo = 'M') THEN re.patologia1 END) AS 'NUEVO_M',
   COUNT(CASE WHEN (a.paciente = 'S' AND p.sexo = 'H') THEN re.patologia1 END) AS 'SUBSIG_H',
   COUNT(CASE WHEN (a.paciente = 'S' AND p.sexo = 'M') THEN re.patologia1 END) AS 'SUBSIG_M',   
...
$registro70 = "SELECT DISTINCT 
   ...
   ON re.expediente = p.expediente 	   
   ".$where40;
$result70 = $mysqli->query($registro70);   
...
$registro80 = "SELECT DISTINCT 
   ...
   ON re.expediente = p.expediente    
   ".$where41;
$result80 = $mysqli->query($registro80);    
...
$objPHPExcel->getProperties()->setTitle("PATOLOGIAS"); //titulo
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "REFERENCIAS ENVIADAS Y RESPUESTAS RECIBIDAS");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:G$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:G$fila");
...
if($result->num_rows>0){
	...
	if($resultF20->num_rows>0){
		while($registroF20_1 = $resultF20->fetch_assoc()){
		   ...
		   $totalsh = $totalsh + $registroF20_1['SUBSIG_H'];
		   $totalsm = $totalsm + $registroF20_1['SUBSIG_M'];			   
     }	
   }	
   ...
   if($resultY04->num_rows>0){
	...
	if($result70->num_rows>0){
		while($registro70_1 = $result70->fetch_assoc()){
	       $fila+=1;
	...
	if($result80->num_rows>0){
		while($registro80_1 = $result80->fetch_assoc()){
	       $fila+=1;
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE PATOLOGIAS REFERENCIAS ENVIADAS '.strtoupper($servicio_name).' '.strtoupper($mes).'_'.$año.'.xls"');
