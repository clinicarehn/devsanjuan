...
$('#descargar_triage').on('click', function(e){
 if (getUsuarioSistema() == 1 || getUsuarioSistema() == 2 || getUsuarioSistema() == 5 || getUsuarioSistema() == 6 || getUsuarioSistema() == 7 || getUsuarioSistema() == 8 || getUsuarioSistema() == 10 || getUsuarioSistema() == 16){	
	e.preventDefault();
...
function eliminarCita(id,comentario){
   ...
   if(getUsuarioSistema() == 1 || getUsuarioSistema() == 6 || getUsuarioSistema() == 7 || getUsuarioSistema() == 8 || getUsuarioSistema() == 10 || getUsuarioSistema() == 16){//SOLO SI EL USUARIO ES ADMINISTRADOR PUEDE ELIMINAR LOS REGISTROS
	    $.ajax({
		   type:'POST',
		   url:url,
