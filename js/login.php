...
function redireccionar(){
	if(getUsuarioSistema() == 2){//MEDICOS
		window.location="<?php echo SERVERURL; ?>vistas/atas.php";
	}else if(getUsuarioSistema() == 3 || getUsuarioSistema() == 4){//3. CAJA | 4. USUARIOS
		window.location="<?php echo SERVERURL; ?>vistas/pacientes.php";
	}else if(getUsuarioSistema() == 5){//ARCHIVO CLINICO
		window.location="<?php echo SERVERURL; ?>vistas/pacientes.php";
	}else if(getUsuarioSistema() == 6 || getUsuarioSistema() == 7 || getUsuarioSistema() == 16){//6. DIRECCION EJECUTIVA | 7. SUBDIRECTORES | 16. GESTION CLINICA
		window.location="<?php echo SERVERURL; ?>vistas/pacientes.php";
	}else if(getUsuarioSistema() == 9){//AUXILIAR DE ENFERMERÍA
		window.location="<?php echo SERVERURL; ?>vistas/preclinica.php";
	}else if(getUsuarioSistema() == 11){//TRANSPORTISTA
		window.location="<?php echo SERVERURL; ?>vistas/transporte_usuarios.php";
	}else if(getUsuarioSistema() == 12){//TALENTO HUMANO
		window.location="<?php echo SERVERURL; ?>vistas/colaboradores.php";
	}else if(getUsuarioSistema() == 14){//TABLERO DE CAMAS
		window.location="<?php echo SERVERURL; ?>vistas/reporte_hospitalizacion.php";
	}else if(getUsuarioSistema() == 15){//FARMACIA
		window.location="<?php echo SERVERURL; ?>vistas/colas_farmacia.php";
	}else{
