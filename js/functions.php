...
function getBloqueoFecha(fecha, colaborador_id, servicio_id){
    var url = '<?php echo SERVERURL; ?>php/citas/getFechaBloqueoHora.php';
	var valor = "";
	$.ajax({
	    type:'POST',
		url:url,
		data:'fecha='+fecha+'&colaborador_id='+colaborador_id+'&servicio_id='+servicio_id,
		async: false,
		success:function(data){
          valor = data;
		}
...
function getComentarioBloqueoHora(fecha, colaborador_id, servicio_id){
	var url = '<?php echo SERVERURL; ?>php/citas/getComentarioBloqueoHora.php';
	var valor = "";
		$.ajax({
		  type:'POST',
			url:url,
