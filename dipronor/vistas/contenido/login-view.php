...
<div id="logreg-forms">
	<form class="form-signin" id="loginform" action="" method="POST" autocomplete="off">
		...
		<p><center><img src="<?php echo SERVERURL; ?>vistas/plantilla/img/logo.png" width="75%" height="55%"></center></p>	
	...
	<form class="form-reset" id="forgot_form">
		...
		<p><center><img src="<?php echo SERVERURL; ?>vistas/plantilla/img/logo.png" width="50%" height="20%"></center></p>	
	...
	<div class="footer-copyright text-center py-3">© 2020 -  <?php echo date("Y");?> Copyright:
		<center>
			...
			<p><center><img src="<?php echo SERVERURL; ?>vistas/plantilla/img/firma.png" width="50%" height="20%"></center></p>
			</p>
		</center>
	</div>
	<!-- Copyright -->  
