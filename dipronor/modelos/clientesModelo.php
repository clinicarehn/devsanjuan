<?php
	...
	class clientesModelo extends mainModel{
		protected function agregar_clientes_modelo($datos){
			...
			$insert = "INSERT INTO clientes VALUES('$cliente_id','".$datos['nombre']."','".$datos['apellido']."','".$datos['rtn']."','".$datos['fecha']."','".$datos['departamento_id']."','".$datos['municipio_id']."','".$datos['localidad']."','".$datos['telefono']."','".$datos['correo']."','".$datos['colaborador_id']."','".$datos['estado']."','".$datos['fecha_registro']."')";
		...
		protected function delete_clientes_modelo($clientes_id){
			$delete = "DELETE FROM clientes WHERE clientes_id = '$clientes_id'";
