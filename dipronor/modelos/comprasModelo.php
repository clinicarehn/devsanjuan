	...
	class comprasModelo extends mainModel{		
		protected function agregar_compras_modelo($datos){
			...
			$insert = "INSERT INTO compras 
				VALUES('$compras_id','".$datos['proveedores_id']."','".$datos['number']."','".$datos['tipoPurchase']."','".$datos['colaboradores_id']."','".$datos['importe']."','".$datos['notas']."','".$datos['fecha']."','".$datos['estado']."','".$datos['usuario']."','".$datos['fecha_registro']."')";
		...
		protected function agregar_cuenta_por_pagar_proveedores($datos){
			...
			$insert = "INSERT INTO pagar_proveedores
				VALUES('$pagar_proveedores_id','".$datos['proveedores_id']."','".$datos['compras_id']."','".$datos['fecha']."','".$datos['saldo']."','".$datos['estado']."','".$datos['usuario']."','".$datos['fecha_registro']."')";
			$result = mainModel::connection()->query($insert) or die(mainModel::connection()->error);
