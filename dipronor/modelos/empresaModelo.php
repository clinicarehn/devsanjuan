	...
	class empresaModelo extends mainModel{
		protected function agregar_empresa_modelo($datos){
			...
			$insert = "INSERT INTO empresa 
				VALUES ('$empresa_id','".$datos['razon_social']."','".$datos['empresa']."','".$datos['otra_informacion']."','".$datos['eslogan']."','".$datos['celular']."','".$datos['telefono']."','".$datos['correo']."','".$datos['rtn']."','".$datos['ubicacion']."','".$datos['estado']."','".$datos['usuario']."','".$datos['fecha_registro']."')";
