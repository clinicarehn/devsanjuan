<?php
	...
	class proveedoresModelo extends mainModel{
		protected function agregar_proveedores_model($datos){
			...
			$insert = "INSERT INTO proveedores VALUES('$proveedores_id','".$datos['nombre']."','".$datos['apellido']."','".$datos['rtn']."','".$datos['fecha']."','".$datos['departamento_id']."','".$datos['municipio_id']."','".$datos['localidad']."','".$datos['telefono']."','".$datos['correo']."','".$datos['estado']."','".$datos['colaborador_id']."','".$datos['fecha_registro']."')";
		...
		protected function delete_proveedores_modelo($proveedores_id){
			$delete = "DELETE FROM proveedores WHERE proveedores_id = '$proveedores_id'";
