...
$_SESSION['menu'] = "Reportes SESAL Anuales";
...
$comentario = mb_convert_case("Ingreso al Modulo Reportes SESAL Anuales", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reportes SESAL Anuales :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reportes SESAL Anuales</li>
	</ol>
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_anuales.php"; 
