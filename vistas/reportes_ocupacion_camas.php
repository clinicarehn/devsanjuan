...
$_SESSION['menu'] = "Reporte Ocupación de Camas";
...
$comentario = mb_convert_case("Ingreso al Modulo Reporte Ocupación de Camas", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte Ocupación de Camas :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Ocupación de Camas</li>
	</ol>
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reporte_ocupacion_camas.php"; 
