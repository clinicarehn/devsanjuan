...
$_SESSION['menu'] = "Reporte de Hospitalización";
...
$comentario = mb_convert_case("Ingreso al Modulo Reporte de Hospitalización", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte de Hospitalización :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte de Hospitalización</li>
	</ol>
    ...
    <form class="form-inline" id="form_main">
	  ...
	  <div class="form-group mr-1">
		<select id="unidad" name="unidad" class="custom-select" style="width:170px;" data-toggle="tooltip" data-placement="top" title="Unidad">
			<option value="">Unidad</option>
		</select>		   
      </div>	
	  <div class="form-group mr-1">
		<select id="profesional" name="profesional" class="custom-select" style="width:170px;" data-toggle="tooltip" data-placement="top" title="Profesional">
			<option value="">Profesional</option>		
		</select>		   
      </div>	
	  <div class="form-group mr-1">
		<select id="estado" name="estado" class="custom-select" style="width:170px;" data-toggle="tooltip" data-placement="top" title="Estado">
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_hospitalizacion.php"; 
