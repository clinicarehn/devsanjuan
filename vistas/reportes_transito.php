...
$_SESSION['menu'] = "Reporte Transito";
...
$comentario = mb_convert_case("Ingreso al Modulo Reporte Transito", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte Transito :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Transito</li>
	</ol>
    ...
    <form class="form-inline" id="form_main">
	  ...
	  <div class="form-group mr-1">
		<input type="text" placeholder="Buscar por: Expediente, Nombre, Apellido o Identidad" id="bs-regis" data-toggle="tooltip" data-placement="top" title="Buscar por: Expediente, Nombre, Apellido o Identidad" autofocus class="form-control" size="30"/> 
      </div>
