...
$_SESSION['menu'] = "Reporte ATA Familiares";
...
$nombre_host = gethostbyaddr($_SERVER['REMOTE_ADDR']);//HOSTNAME$nombre_host = getRealIP();	$fecha = date("Y-m-d H:i:s"); 
...
<head>
    ...
    <title>Reporte ATA Familiares :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte ATA Familiares</li>
	</ol>
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_atas_familiares.php"; 
