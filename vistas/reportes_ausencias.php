...
$_SESSION['menu'] = "Reporte Usuarios";
...
$comentario = mb_convert_case("Ingreso al Modulo de Reporte Usuarios", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte de Usuarios :: <?php echo $empresa; ?></title>
			...
			<form id="mensaje_sistema">		
				<div class="form-row">
					<div class="col-md-12 mb-3">
					   <div class="modal-title" id="mensaje_informacion"></div>
					</div>					
				</div>				
			</form>
      </div>
