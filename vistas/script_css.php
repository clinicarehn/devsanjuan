...
<link rel="stylesheet" href="<?php echo SERVERURL; ?>css/table_style_show_hide.css" type="text/css" media="screen">
<link rel="stylesheet" href="<?php echo SERVERURL; ?>login/css/all.min.css" type="text/css" media="screen"><!--//USO DE ICONOS font awesome-->