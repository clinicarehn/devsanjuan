...
<div class="container-fluid">
	...
	<div class="container-fluid" id="main_facturacion">
		<form class="form-inline" id="form_main">
		  ...
		  <div class="form-group mr-1">
				<input type="date" required="required" id="fecha_b" name="fecha_b" data-toggle="tooltip" data-placement="top" title="Fecha Inicial" value="<?php echo date ("Y-m-d");?>" class="form-control"/>
		  </div>
		  <div class="form-group mr-1">
		  ...
		  <div class="form-group mr-1">
		     <button class="btn btn-primary ml-1" type="submit" id="factura" data-toggle="tooltip" data-placement="top" title="Crear Factura"><div class="sb-nav-link-icon"></div><i class="fas fa-file-invoice fa-lg"></i> Factura</button>
		  </div>
		  <div class="form-group mr-1">
