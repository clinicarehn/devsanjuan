...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SERVERURL; ?>login/css/all.css"><!--//USO DE ICONOS font awesome-->
...
<body>
    <div id="logreg-forms">
        <form class="form-signin" id="loginform">
           ...
           <p><center><img src="../img/logo.png" width="70%"></center></p>	
        ...
        <form class="form-signup" id="form_registro">
		    ...
		    <p><center><img src="../img/logo.png" width="100%"></center></p>
            ...
            <div class="input-group mb-3">
               ...
               <select class="form-control" name="base_datos1" id="base_datos1">
                <option value="1">Sanjuan</option>
                <option value="2">Test_sanjuan</option>
            </select>
            </div>
        ...
        <div class="footer-copyright text-center py-3">
		   <center><img src="<?php echo SERVERURL; ?>img/logo_clinicare_footer.png"></center>© 2017 -  <?php echo date("Y");?> Copyright: 
           <center>
