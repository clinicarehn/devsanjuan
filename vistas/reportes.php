...
$comentario = mb_convert_case("Ingreso al Modulo Reportes SESAL", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reportes SESAL :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte de Atenciones</li>
	</ol>
    ...
    <form class="form-inline" id="form_main">
	  ...
	  <div class="form-group mr-1">
		<select id="medico_general" name="medico_general" class="custom-select" style="width:170px;" data-toggle="tooltip" data-placement="top" title="Profesional">
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes.php"; 
