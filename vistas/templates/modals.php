...
<div class="dropdown-menu dropdown-menu-sm" id="context-menu">
  <input type="hidden" class="form-control" id="context-pacientes_id">
  <input type="hidden" class="form-control" id="context-agenda_id">
  <a class="dropdown-item" href="#" id="menu-mover"><i class="fas fa-exchange-alt"></i> Mover Servicio</a>
  <a class="dropdown-item" href="#" id=menu-imprimir><i class="fas fa-print"></i> Imprimir</a>
  <a class="dropdown-item" href="#" id="menu-eliminar"><i class="fas fa-trash"></i> Eliminar</a>
</div>
<!--FIN CONTEXT MENU-->

<!--INICIO CONTEXT MENU-->
<div class="dropdown-menu dropdown-menu-sm" id="context-menu-cita">
  <a class="dropdown-item" href="#" id="menu_cita"><i class="fas fa-exchange-alt"></i> Crear Cita</a>
  <a class="dropdown-item" href="#" id=menu_bloquear><i class="fas fa-user-lock"></i> Bloquear Hora</a>
</div>
<!--FIN CONTEXT MENU-->
